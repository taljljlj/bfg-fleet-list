...
The application is based on the **Battlefleet Gothic Remastered official rulebook v1.10** and is designed as a community tool for public use. In addition to fleet building, it can export fleet data into a readable PDF format for use during game sessions, whether digitally or as a printed reference sheet.
