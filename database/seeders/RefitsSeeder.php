    ...
    public function run(): void
    {
        $refits = [
            ...
            [
                ...
                "module1" => "Special",
                "value1" => "Targeting Matrix: Left column shift",
            ],
            [
                "name" => "Turrets",
                "text" => "Turrets +1",
            ...
            [
                ...
                "module1" => "Prow Torpedoes",
                "action1" => "replace",
                "value1" => "Prow Nova Cannon"
            ],
            [
            ...
            [
                ...
                "module1" => "Special",
                "value1" => "Enemy contacts Ld bonus doubled",
                "module2" => "Weapons Battery",
                "action2" => "remove",
            ],
            [
            ...
            [
                ...
                "module1" => "Broadside Lance Battery",
            ],
            [
            ...
            [
                ...
                "module1" => "Speed|30;Special|Xenotech: Advanced Drive Technology (+1D6 All Ahead Full);Weapons Battery|remove",
            ],
            [
            ...
            [
                ...
                "module1" => "Weapons Battery|4;Lance Battery|add(2,45)",
            ],
            [
                "name" => "Chaos Lord",
                "text" => "Chaos Lord +1Ld",
