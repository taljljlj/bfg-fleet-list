...
<body>
    <div class="page">
        <div class="content-wrapper">
            <div class="header">
                <div class="header-l">
                    <h1>{{ $fleet->faction->name ?? 'No Faction Selected' }}</h1>
                    <h3>{{ $fleet->fleetList->name ?? 'No Fleet List Selected' }}</h3>
                </div>
                <div class="header-r">
                    <h1>{{ $fleet->points }}</h1>
                    <h3>Pts</h3>
            ...
            <div class="header">
                <div class="header-l commander-list">
                    @if($fleet->commanders->isNotEmpty())
            ...
            <div class="ships-container">
                @if($fleet->ships->isNotEmpty())
                    @foreach($fleet->ships as $ship)
                        <x-fleet-builder.ship-profile-card-export :ship="$ship" :commanders="$fleet->commanders"/>
