        ...
        >
            <ul>
                <li
                    ...
                    class="tracking-wider py-0.5 px-1.5 cursor-pointer border-b-2 border-t-2 border-transparent hover:text-white hover:border-secondary w-full h-full truncate"
                >
                    {{ item[labelKey] }}
                </li>
            </ul>
